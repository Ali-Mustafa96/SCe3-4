...
main (int argc, char *argv[])
{
  ...
  topologyReader.SetFileName("src/ndnSIM/examples/topologies/topo-tree-Distribute4.txt");
  topologyReader.Read();
...
// Metrics:
    ...
    ndn::AppDelayTracer::InstallAll ("Distributed-Delays-trace4.txt"); //Delay
    
    L2RateTracer::InstallAll("Distributed-drop-trace4.txt", Seconds(0.5)); //packet drop rate (overflow)
